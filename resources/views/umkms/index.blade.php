<x-layout>
    ...
    <body>
        <div class="container py-5">
            <div class="mb-4">
                <form action="{{ route('umkms.index') }}" method="GET" class="form-inline">
            ...
            <a href="{{ route('umkms.create') }}" class="btn btn-primary mb-4">Tambah UMKM Baru</a>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <a href="{{ route('umkms.show', $umkm->id_umkm) }}" class="btn btn-info btn-sm">Lihat</a>
                            <a href="{{ route('umkms.edit', $umkm->id_umkm) }}" class="btn btn-warning btn-sm">Edit</a>
